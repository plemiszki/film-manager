...
ActiveRecord::Schema[8.1].define(version: 2026_01_30_203633) do
  ...
  create_table "amazon_genres", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["code"], name: "index_amazon_genres_on_code", unique: true
  end
  ...
  create_table "institution_orders", force: :cascade do |t|
    ...
    t.string "invoice_notes", default: ""
    t.date "materials_sent"
  ...
  add_foreign_key "emails", "users", column: "sender_id"
end
