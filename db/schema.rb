...
ActiveRecord::Schema.define(version: 20180203145229) do
  ...
  add_index "bookings", ["advance_invoice_id"], name: "index_bookings_on_advance_invoice_id", using: :btree
  ...
  add_index "bookings", ["overage_invoice_id"], name: "index_bookings_on_overage_invoice_id", using: :btree
