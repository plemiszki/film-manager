class Api::WebsiteController < CyberController
  ...
  def films
    @films = Film.all.includes(:formats, :licensor, :countries, :languages, :genres, :topics, :directors, :actors, :laurels, :quotes, :related_films, dvds: [:dvd_type, :dvd_shorts]).order(:id)
