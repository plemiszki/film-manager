    ...
    switch (this.props.entityName) {
      ...
      case "dvdCustomer":
        return [
          ...
          <div
            key="2"
            className={`row${this.state.dvdCustomer.consignment ? " placeholder" : ""}`}
          >
            {Details.renderField.bind(this)({
              columnWidth: 6,
              entity: "dvdCustomer",
          ...
          <hr key="3" />,
          <p key="4" className="section-header">
            Billing Address
          </p>,
      ...
      case "eduPlatformFilm":
        return [
          <div key="1" className="row">
            {Details.renderDropDown.bind(this)({
              columnWidth: 4,
              entity: "eduPlatformFilm",
              property: "eduPlatformId",
              type: "dropdown",
              columnHeader: "Platform",
              options: this.state.eduPlatforms || [],
              optionDisplayProperty: "name",
              maxOptions: 3,
            })}
            {Details.renderField.bind(this)({
        ...
        return [
          <div key="1" className="row">
            ...
            {Details.renderField.bind(this)({
              ...
              entity: "laurel",
              property: "awardName",
              columnHeader: "Award Name (Optional)",
            })}
          </div>,
          <div key="2" className="row">
            {Details.renderField.bind(this)({
        ...
        return [
          <div key="1" className="row">
            ...
            {Details.renderDropDown.bind(this)({
              ...
              columnHeader: "Type",
              options: this.state.merchandiseTypes || [],
              optionDisplayProperty: "name",
            })}
          </div>,
          <div key="2" className="row">
          ...
          <div key="1" className="row">
            ...
            <div className="col-xs-3">
              ...
              <select
                ...
                value={this.state.venue.venueType}
                data-entity="venue"
