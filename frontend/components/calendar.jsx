            ...
            <table>
              ...
              <tbody>
                {months.map((month, index) => {
                  return (
                    <tr key={index}>
                      <td className="monthCell">{MONTHS[index]}</td>
                      <td data-test="theatrical">
                        {months[index].theatricalReleases.map(
                          (theatricalRelease, index) => {
                            return (
                              <div
                                key={index}
                                className={
                                  "film" +
                                  (theatricalRelease.tentative
                                    ? " tentative"
                                    : "")
                                }
                              >
                          ...
                          (tvodRelease, index) => {
                            return (
                              <div
                                ...
                                className={
                                  "film" +
                                  (tvodRelease.tentative ? " tentative" : "")
                                }
                              >
                                {tvodRelease.title}
                                <br />
                      ...
                      <td data-test="fm-plus">
                        {months[index].fmPlusReleases.map(
                          (fmPlusRelease, index) => {
                            return (
                              <div key={index} className={"film"}>
                                {fmPlusRelease.title}
