...
export default class GiftboxDetails extends React.Component {
  ...
  render() {
    const { giftbox, giftboxDvds, justSaved, changesToSave, spinner } =
      this.state;
    return (
      <>
        <div className="handy-component">
          ...
          <div id="giftbox-profile-box" className="white-box">
            ...
            <OutlineButton
              text="Add DVD"
              onClick={() => {
                this.setState({ dvdsModalOpen: true });
              }}
            />
