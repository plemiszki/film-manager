...
export default class ReportsIndex extends React.Component {
  ...
  componentDidMount() {
    setUpNiceSelect({
      selector: "select",
      func: (e) => {
        this.setState({ daysDue: e.target.value });
      },
    });
          ...
          <div className="handy-component">
            ...
            <div className="white-box">
              <SearchBar
                ...
                value={searchText || ""}
                style={{ position: "absolute", right: "32px", top: "12px" }}
              />
              <select
  ...
  componentDidUpdate() {
    Common.updateJobModal.call(this, {
      ensureCallback: this.importCallback.bind(this),
    });
  }
