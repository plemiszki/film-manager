...
export default class VirtualBookingDetails extends React.Component {
  ...
  checkForChanges() {
    return !objectsAreEqual(
      this.state.virtualBooking,
      this.state.virtualBookingSaved,
    );
  }
  ...
  render() {
    const { justSaved, changesToSave, spinner, deleteInvoiceModalOpen } =
      this.state;
    return (
      <div className="handy-component">
        ...
        <div className="white-box">
          ...
          <div className="row">
            ...
            {Details.renderField.bind(this)({
              ...
              entity: "virtualBooking",
              property: "terms",
              redHeader: !this.state.virtualBookingSaved.termsValid,
            })}
            {Details.renderField.bind(this)({
              columnWidth: 2,
              entity: "virtualBooking",
        ...
        <Modal
          ...
          onRequestClose={Common.closeModals.bind(this)}
          contentLabel="Modal"
          style={Common.newEntityModalStyles({ width: 700 }, 1)}
        >
          <NewEntity
            entityName="payment"
            initialEntity={{
            ...
            context={this.props.context}
            callbackFullProps={this.updatePayments.bind(this)}
          />
        </Modal>
        <ConfirmDelete
          ...
          <div className="row">
            ...
            <div className="col-xs-6">
              ...
              <ListBox
                ...
                entities={payments}
                clickDelete={(payment) => {
                  this.clickDeletePayment(payment.id);
                }}
              ...
              <div className="col-xs-6">
                ...
                <Button
                  ...
                  text={
                    changesToSave
                      ? "Save to Send"
                      : virtualBooking.reportSentDate === "(Not Sent)"
                        ? "Send Report"
                        : "Send Another Report"
                  }
                  onClick={() => {
                    this.clickSendReport();
                  }}
                  style={{
                    paddingTop: 14,
                    paddingBottom: 14,
  ...
  componentDidUpdate() {
    ...
    Common.updateJobModal.call(this, {
      successCallback: () => {
        ...
        sendRequest(`/api/virtual_bookings/${virtualBooking.id}/invoices`).then(
          (response) => {
            const { invoices } = response;
            this.setState({
              spinner: false,
