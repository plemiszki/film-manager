...
const renderSearchIndex = (id, props = {}, args = {}) => {
  const { searchCriteria: searchCriteriaProps, newEntity: newEntityProps } =
    args;
  const node = document.getElementById(id);
  if (node) {
    const root = createRoot(node);
...
document.addEventListener("DOMContentLoaded", () => {
  const currentUserInfo =
    document.getElementsByClassName("current-user")[0].dataset;
  ...
  renderSimpleDetails("setting-details", {
    ...
    fields: [
      [
        {
          columnWidth: 12,
          property: "bookingConfirmationText",
          columnHeader: "Booking Confirmation Email Copy",
          type: "textbox",
          rows: 15,
        },
        {
          columnWidth: 12,
          property: "unpaidNonOverageBookingInvoiceEmailText",
          columnHeader: "Unpaid Non-Overage Booking Invoice Email Copy",
          type: "textbox",
          rows: 6,
        },
        {
          columnWidth: 12,
          property: "unpaidOverageBookingInvoiceEmailText",
          columnHeader: "Unpaid Overage Booking Invoice Email Copy",
          type: "textbox",
          rows: 6,
        },
        {
          columnWidth: 12,
          property: "partiallyPaidBookingInvoiceEmailText",
          columnHeader: "Partially Paid Booking Invoice Email Copy",
          type: "textbox",
          rows: 6,
        },
        {
          columnWidth: 12,
          property: "paidBookingInvoiceEmailText",
          columnHeader: "Paid Booking Invoice Email Copy",
          type: "textbox",
          rows: 6,
        },
        {
          columnWidth: 12,
          property: "bookingInvoicePaymentInfoEmailText",
          columnHeader: "Booking Invoice Payment Info Email Copy",
          subheader:
            "Included in all booking invoice emails with a balance due.",
          type: "textbox",
          rows: 15,
        },
        {
          columnWidth: 12,
          property: "shippingTermsEmailText",
          columnHeader: "Booking Invoice Shipping Terms Email Copy",
          subheader:
            "Included in invoice emails for non-theatrical or festival bookings with an advance.",
          type: "textbox",
          rows: 4,
        },
        {
          columnWidth: 12,
          property: "allBookingInvoicesEmailText",
          columnHeader: "Booking Invoices Additional Email Copy",
          subheader: "Included at the end of all booking invoice emails.",
          type: "textbox",
          rows: 4,
        },
        {
          columnWidth: 12,
          property: "dvdInvoiceEmailText",
          columnHeader: "DVD Invoice Email Copy",
          type: "textbox",
          rows: 10,
        },
        {
          columnWidth: 12,
          property: "creditMemoEmailText",
          columnHeader: "Credit Memo Email Copy",
          type: "textbox",
          rows: 8,
        },
        {
          columnWidth: 12,
          property: "virtualBookingReportText",
          columnHeader: "Virtual Booking Report Email Copy",
          type: "textbox",
          rows: 6,
        },
        {
          columnWidth: 12,
          property: "institutionOrderInvoiceEmailText",
          columnHeader: "Educational Invoice Email Copy",
          type: "textbox",
          rows: 6,
        },
        {
  ...
  renderSimpleDetails("quote-details", {
    ...
    deleteCallback: function () {
      window.location.pathname = `/films/${this.state.quote.filmId}`;
  ...
  renderSimpleDetails("film-right-details", {
    ...
    deleteCallback: function () {
      window.location.pathname = `/films/${this.state.filmRight.filmId}`;
    }, // arrow function won't work here
  });
      ...
      [
        {
          ...
          type: "modal",
          optionDisplayProperty: "name",
          optionsArrayName: "digitalRetailers",
        },
        { columnWidth: 7, columnHeader: "URL", property: "url" },
      ],
    ],
    deleteCallback: function () {
      window.location.pathname = `/films/${this.state.digitalRetailerFilm.filmId}`;
    },
  });
  ...
  renderSimpleDetails("sub-right-details", {
    ...
    deleteCallback: function () {
      window.location.pathname = `/sublicensors/${this.state.subRight.sublicensorId}`;
    },
  });
  ...
  renderSimpleDetails("merchandise-item-details", {
    ...
    fields: [
      [
        ...
        {
          columnWidth: 6,
          property: "merchandiseTypeId",
          columnHeader: "Type",
          type: "dropdown",
          optionsArrayName: "merchandiseTypes",
          optionDisplayProperty: "name",
        },
      ],
  ...
  renderSimpleDetails("amazon-genre-details", {
    ...
    fields: [[{ columnWidth: 12, property: "code" }]],
  ...
  renderSimpleDetails("country-details", {
    entityName: "country",
    initialEntity: { name: "" },
    fields: [[{ columnWidth: 12, property: "name" }]],
    customDeletePath: "/settings",
  });
      ...
      [
        {
          ...
          property: "eduPlatformId",
          type: "modal",
          optionDisplayProperty: "name",
          optionsArrayName: "eduPlatforms",
        },
        { columnWidth: 7, columnHeader: "URL", property: "url" },
      ],
    ],
    deleteCallback: function () {
      window.location.pathname = `/films/${this.state.eduPlatformFilm.filmId}`;
    },
  });
    ...
    },
    {
      searchCriteria: {
        fields: [
          ...
          {
            name: "number",
            columnHeader: "Credit Memo Number",
            columnWidth: 6,
          },
          {
            name: "num",
      ...
      searchCriteria: {
        fields: [
          ...
          { name: "shippingState", columnHeader: "State", columnWidth: 2 },
          {
            ...
            type: "checkboxes",
            options: [
              { value: "Theatrical", text: "Theatrical" },
    ...
    },
    {
      searchCriteria: {
        fields: [
          ...
          { name: "shippingState", columnHeader: "State", columnWidth: 2 },
          {
            name: "boxOfficeReceived",
            columnHeader: "BO Received",
            type: "yes/no",
            columnWidth: 4,
          },
          {
            name: "invoiceOrReportSent",
            columnHeader: "Invoice/Report",
            type: "yes/no",
            columnWidth: 4,
          },
          {
  ...
  const sublicensorRightsIndexNode = document.getElementById(
    "sublicensor-rights-index",
  );
        ...
        <SearchCriteria
          fields={[
            ...
            },
            {
              ...
              type: "modal",
              optionDisplayProperty: "name",
              responseArrayName: "territories",
              columnWidth: 6,
            },
          ]}
        />
        <FilmRightsNew initialEntity={{}} sublicensorId={sublicensorId} />
      </SearchIndex>,
    );
  }
});
