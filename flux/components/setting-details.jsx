        ...
        <div className="component">
          ...
          <div className="white-box">
            ...
            <div className="row">
              ...
              { Details.renderTextBox.bind(this)({ columnHeader: 'Booking Invoice Payment Info Email Copy', subheader: 'Included in all booking invoice emails with a balance due.', rows: 6, columnWidth: 12, entity: 'settings', property: 'bookingInvoicePaymentInfoEmailText' }) }
